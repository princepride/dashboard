...
const ConsoleAccordion = ({ message, curState }) => {
  ...
  return (
    <div className="w-full flex flex-col">
      <button type="button" onClick={toggleAccordion} className="flex items-center p-2 justify-between w-full font-medium text-left text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800">
